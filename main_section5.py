...
def main():
    ...
    # File processing
    def process_one_file(h5_path: Path, north_csv: str, south_csv: str, utm_xf: float, utm_y0: float) -> list:
    ...
    plt.savefig('figs/Figure7e.pdf', format='pdf', bbox_inches='tight', transparent=True)
    #plt.show()
    ...
    plt.savefig('figs/Figure7b.pdf', format='pdf', bbox_inches='tight', transparent=True)
    #plt.show()
    ...
    plt.savefig('figs/Figure7d.pdf', format='pdf', bbox_inches='tight', transparent=True)
    #plt.show()
    ...
    plt.savefig('figs/Figure7c.pdf', format='pdf', bbox_inches='tight', transparent=True)
    #plt.show()
